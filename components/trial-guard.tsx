          ...
          <div className="relative z-10 space-y-8 w-full">
            ...
            <div className="flex flex-col items-center space-y-6">
              ...
              <div className="space-y-3">
                ...
                <h2 className="text-6xl font-[900] tracking-tight text-white leading-none">
                  SYSTEM <span className="text-primary italic">SUSPENDED</span>
                </h2>
                <p className="text-2xl text-blue-100/40 font-medium tracking-tight">
                  Your trial access period has expired.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-8 w-full">
              <div className="p-10 bg-white/[0.03] rounded-[2.5rem] border border-white/10 backdrop-blur-xl shadow-inner relative group/box">
                ...
                <p className="text-2xl leading-[1.6] text-white/90 font-medium tracking-tight">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="flex flex-col items-center justify-center p-8 bg-primary hover:bg-primary/90 text-white rounded-[2rem] shadow-[0_20px_40px_-10px_rgba(var(--primary),0.3)] transition-all duration-300 transform-gpu cursor-default">
                  <div className="flex items-center gap-3 mb-2">
                    <Phone className="w-7 h-7" />
                    <span className="text-3xl font-black tracking-tighter tabular-nums">{CEO_NUMBER}</span>
                  </div>
                  <span className="text-xs font-bold uppercase tracking-[0.3em] opacity-70">Official Support</span>
                </div>

                <button 
                  onClick={handleSnooze}
                  className="flex flex-col items-center justify-center p-8 bg-white/[0.07] hover:bg-white/[0.12] text-white rounded-[2rem] border border-white/10 transition-all duration-300 active:scale-[0.97]"
                >
                  <div className="flex items-center gap-3 mb-2">
                    <CheckCircle2 className="w-6 h-6 text-green-400" />
                    <span className="text-xl font-bold">Renew Access</span>
                  </div>
                  <span className="text-[10px] font-bold uppercase tracking-[0.2em] opacity-40">Temporary (10 Hours)</span>
                </button>
              </div>
            </div>
